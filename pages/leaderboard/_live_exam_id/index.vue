            ...
            <b-table small :fields="fields" :items="leaderboard.leaders" responsive="sm">
              <!-- A virtual column -->
                  ...
                  <template #cell(name)="data">
                    <b-img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQixqjpXBp3M_ies5uGa1eyUfXYaydVgxlHwg&usqp=CAU" 
                    width= "70" height="70" rounded="circle" alt="Circle image" ></b-img>
